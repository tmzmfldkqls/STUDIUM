...
function makecell(data,tag) {
	...
	if(tag == "status") {
		...
		if(txtNode.nodeValue == '등록중'){
			option.setAttribute("selected", "selected");
		}else if(txtNode.nodeValue == '삭제'){
			option1.setAttribute("selected", "selected");
		}
		select.appendChild(option);
		option.setAttribute("value", "1");		
		option.appendChild(document.createTextNode("등록중"));
		select.appendChild(option1);
		option1.setAttribute("value", "0");
		option1.appendChild(document.createTextNode("삭제"));	
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">스터디공간관리
					<div align="right">
					<select id="key">
					<option value="sp_name">공간 이름</option>
					<option value="sp_tag">공간 테그</option>
					<option value="sp_web">웹사이트</option>
					</select>
					<input type="text" id="word" name="word">
					<input type="button" value="검색" onclick="javascript:spacelist();">	
					</div>
					</div>
					<!-- /.panel-heading -->
					<div class="panel-body">
						<table class="table  table-hover table-bordered table-sm">
							<thead class="thead-dark">
								<tr>
									<th style="width: 80px;">공간 번호</th>
									<th style="width: 100px;">공간 이름</th>
									<th style="width: 400px;">간단한 설명</th>
									<th style="width: 100px;">공간 테그</th>	
									<th style="width: 150px;">웹사이트</th>
									<th style="width: 80px;">공간 상태</th>
								</tr>
							</thead>
