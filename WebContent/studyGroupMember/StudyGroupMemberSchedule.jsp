...
window.onload = function(){
	...
	var params = "act=membertodayschedule";
	sendRequest(url, params, mslist, "GET");
}


function check(date){
	 var selectDate = date;
	 var param ="act=memberViewSchedulelist&date=" + selectDate;
	 sendRequest("<%=root%>/groupschedule", param, mslist, "GET");
	}
	...
	function makelist(data) {
		var output = "";
		var len = data.getElementsByTagName("MemberStudyGroupSchedule").length;
			for (var i = 0; i < len; i++) {
		...
		document.getElementById("mslist").innerHTML = output;
	}
