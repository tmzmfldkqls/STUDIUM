...
(function () {
    ...
    Module.directive("rmDatepicker", ['rmDatepickerConfig', '$compile', '$filter', '$document', '$timeout',
        ...
        var link = function (scope, element, attrs, ngModel) {
            ...
            var send= function (oDate) {             
            	 var date =oDate.getFullYear() + "-" + ((oDate.getMonth()+1)<10 ? "0"+ (oDate.getMonth()+1) : (oDate.getMonth()+1)) + "-" + (oDate.getDate()<10 ? "0" + oDate.getDate() : oDate.getDate());     
            	 check(date);
