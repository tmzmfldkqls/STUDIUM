...
public class StudyGroupTodayScheduleListXml implements Action {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response)
		...
		if(memberDto != null) {
			...
			List<StudyGroupScheduleDto> slist = ScheduleServiceImpl.getScheduleService().viewTodaySchedule(SNO);
			System.out.println("slist dhodhodho" + slist.size());
			if(slist.size() == 0) {
